...
namespace Britannica.Application.MediatR
{
    internal static class ContainerBuilderExtensions
    {
        ...
        public static ContainerBuilder RegisterMediatR(this ContainerBuilder builder, Assembly assembly/*, params Type[] customBehaviorTypes*/)
            => RegisterMediatRInternal(builder, new[] {assembly}/*, customBehaviorTypes*/);

        private static ContainerBuilder RegisterMediatRInternal(ContainerBuilder builder, IEnumerable<Assembly> assemblies/*, IEnumerable<Type> customBehaviorTypes = null*/)
        {
